        ...
        <div class="comment-item">
          ...
          <div class="comment-detail">
            <div class="user-info">
              ...
              ><span class="create-time"><?php echo time_tran2($comment['pub_time']); ?></span>
            </div>
            <p class="content">
            ...
            <div class="footer">
              <span class="reply-btn" reply="<?php echo $comment['id']; ?>">回复</span>
              ...
              <span reply="<?php echo $comment['id']; ?>" class="reply-num"
                ...
                ><i class="bui-icon icon-report"></i></span>
                <!--
                <span class="digg" title="点赞"
                >489&nbsp;<i class="bui-icon icon-thumbsup_line">赞</i
              ></span>
              -->
            </div>
