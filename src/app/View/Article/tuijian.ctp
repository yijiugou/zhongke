<div class="art-con">
    <div class="nav">
        <span class="addarticle"><a href="/Article/addedittuijian">添加推荐</a></span>
    </div>
    <div class="search">
        <span>文章名称:</span>
            ...
            <?php foreach($list as $item){ ?>
                <li>
                    <!--<span><?php echo $item['id'];?></span><span><?php echo $item['title'];?></span><span><?php echo $item['created'];?></span><span><?php echo $item['view_num'];?></span><span><span class="bnt"> <a-->
                        <!--href="/Article/addedittuijian?id=<?php echo $item['id'];?>">修改</a></span><span class="bnt subdel">删除</span></span>-->
