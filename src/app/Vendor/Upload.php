<?php
App::uses('Local', 'Vendor/driver/Upload');
defined('UPLOAD_PATH')?0:define('UPLOAD_PATH','upload/');
defined('__ROOT__')?0:define('__ROOT__','/app/webroot');
class Upload {
    /**
     * 默认上传配置
     * @var array
